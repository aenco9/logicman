...
//Descripcion: Codigo fuente de la compuerta or para hacer calculos y administrar los elementos visuales.
...
public class Or : MonoBehaviour
{
    ...
    //Operación lógica
    void CalcularOr(PersonajeMinijuego jugador){
        //Quitar colliders
        ...
        jugador.Or(entrada1 || entrada2, transform.position.y);
        ActualizarLetreros(); 
    }   
